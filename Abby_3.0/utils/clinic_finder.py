...
class ClinicFinder:
    ...
    def __init__(self, clinics_data_file=None):
        """
        ...
        if clinics_data_file is None:
            # Use absolute path relative to the project root
            clinics_data_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "clinics_data.json")
    ...
    def _load_clinics_data(self):
        ...
        try:
            ...
            with open(self.clinics_data_file, 'r') as f:
                ...
                logger.info(f"Loaded data for {len(clinics)} clinics")
                return clinics
