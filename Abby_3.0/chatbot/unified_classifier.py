...
IMPORTANT INSTRUCTION FOR LOCATIONS:
Only list locations in the detected_locations field if they are explicitly mentioned as a US state name, standard 2-letter abbreviation, or 5-digit ZIP code. Do not infer location from context unless the user explicitly asks about "my state" or "my area". If no location is explicitly mentioned, detected_locations must be an empty list [] and contains_location must be false.
"""
